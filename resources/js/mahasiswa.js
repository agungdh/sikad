...
window.vpage = new Vue({
    ...
    methods: {
      ...
      store: function() {
      axios.post(baseUrl + '/mahasiswa', vpage.formData)
      ...
      .catch(function (error) {
        ...
        if (error.response.data.errors) {
          ...
          // EDIT HERE
          vpage.formDataErrors.npm = formErrors.npm ? formErrors.npm[0] : '';
      ...
      getData: function(id) {
        vpage.startLoading();
      axios.get(baseUrl + '/mahasiswa/' + id)
      .then(function (response) {
        ...
        vpage.formData.npm = response.data.npm;
      ...
      update: function(id) {
      axios.put(baseUrl + '/mahasiswa/' + id, vpage.formData)
      .then(function (response) {
        vpage.stopLoading();
        vpage.resetForm();
        vpage.call();
      ...
      stopLoading: function() {
        ...
        vpage.startLoading();
			...
			axios.post(baseUrl + '/mahasiswa/getTableData', {
    	...
    	delete: function(id) {
      vpage.startLoading();
			axios.delete(baseUrl + '/mahasiswa/' + id)
		  .then(function (response) {
        vpage.stopLoading();
