            ...
            <div class="table-responsive">
              <table class="table table-striped dataTable">
                <thead>
                  ...
                  <tr>
                    <th>
                      <input :disabled="isLoading" type="text" class="form-control form-control-sm" placeholder="Cari Kode Mata Kuliah" v-model="tableParam.search.kode" @@change="call">
                    </th>
                    <th>
                      <input :disabled="isLoading" type="text" class="form-control form-control-sm" placeholder="Cari Mata Kuliah" v-model="tableParam.search.matkul" @@change="call">
                    </th>
                  </tr>
                </thead>
                <tbody>
